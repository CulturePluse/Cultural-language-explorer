...
const ARScanner = () => {
  ...
  // Use window.location.host to make it work on any localhost port
  const qrCodeUrl = "http://localhost:3000/ARScanner/";
    ...
    <div className="scanner-container">
      ...
      <div className="scanner-grid">
        <div className="how-it-works">
          ...
          <ul>
            <li><FaCamera /> Point your camera at any object or text in your environment</li>
            <li><span>✏</span> Our AR system will recognize the object or text</li>
            <li><FaLanguage /> See the translation in your chosen African language instantly</li>
          </ul>
        </div>
      ...
      <div className="camera-area">
        {scannerActive ? (
          ...
          <div className="qr-code-container">
            ...
            <p className="qr-instruction">Or click "Start Scanner" to use camera</p>
          </div>
        )}
      </div>
